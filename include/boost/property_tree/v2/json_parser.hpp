...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_JSON_PARSER_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_JSON_PARSER_HPP_INCLUDED

#include <boost/property_tree/version.hpp>
#include <boost/property_tree/v2/ptree.hpp>
#include <boost/property_tree/v2/detail/json_parser_read.hpp>
#include <boost/property_tree/v2/detail/json_parser_write.hpp>
#include <boost/property_tree/v2/detail/json_parser_error.hpp>

#include <fstream>
#include <string>
#include <locale>

BOOST_PROPERTY_TREE_OPENNS(2) namespace json_parser {
