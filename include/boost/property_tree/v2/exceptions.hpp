...
#ifndef BOOST_PROPERTY_TREE_V2_EXCEPTIONS_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_EXCEPTIONS_HPP_INCLUDED
...
#include <boost/property_tree/v2/detail/exception_implementation.hpp>
