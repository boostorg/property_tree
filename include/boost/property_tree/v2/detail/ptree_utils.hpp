...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_DETAIL_PTREE_UTILS_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_DETAIL_PTREE_UTILS_HPP_INCLUDED
...
BOOST_PROPERTY_TREE_OPENNS(2) namespace detail {
