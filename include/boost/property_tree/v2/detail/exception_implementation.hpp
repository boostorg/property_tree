...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_DETAIL_EXCEPTIONS_IMPLEMENTATION_HPP_INCLUDED
