...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_DETAIL_INFO_PARSER_WRITER_SETTINGS_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_DETAIL_INFO_PARSER_WRITER_SETTINGS_HPP_INCLUDED
