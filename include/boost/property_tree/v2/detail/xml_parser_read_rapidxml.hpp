...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_DETAIL_XML_PARSER_READ_RAPIDXML_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_DETAIL_XML_PARSER_READ_RAPIDXML_HPP_INCLUDED
...
#include <boost/property_tree/v2/detail/xml_parser_utils.hpp>
#include <boost/property_tree/v2/detail/rapidxml.hpp>
#include <vector>
