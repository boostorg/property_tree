...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_INFO_PARSER_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_INFO_PARSER_HPP_INCLUDED

#include <boost/property_tree/version.hpp>
#include <boost/property_tree/v2/ptree.hpp>
#include <boost/property_tree/v2/detail/info_parser_error.hpp>
#include <boost/property_tree/v2/detail/info_parser_writer_settings.hpp>
#include <boost/property_tree/v2/detail/info_parser_read.hpp>
#include <boost/property_tree/v2/detail/info_parser_write.hpp>
#include <istream>

BOOST_PROPERTY_TREE_OPENNS(2) namespace info_parser {
