...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_INI_PARSER_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_INI_PARSER_HPP_INCLUDED
...
#include <boost/property_tree/v2/detail/file_parser_error.hpp>
#include <fstream>
#include <string>
#include <sstream>
#include <stdexcept>
...
BOOST_PROPERTY_TREE_OPENNS(2) namespace ini_parser {
