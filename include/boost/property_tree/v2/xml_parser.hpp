...
// ----------------------------------------------------------------------------
#ifndef BOOST_PROPERTY_TREE_V2_XML_PARSER_HPP_INCLUDED
#define BOOST_PROPERTY_TREE_V2_XML_PARSER_HPP_INCLUDED

#include <boost/property_tree/version.hpp>
#include <boost/property_tree/v2/ptree.hpp>
#include <boost/property_tree/v2/detail/xml_parser_write.hpp>
#include <boost/property_tree/v2/detail/xml_parser_error.hpp>
#include <boost/property_tree/v2/detail/xml_parser_writer_settings.hpp>
#include <boost/property_tree/v2/detail/xml_parser_flags.hpp>
#include <boost/property_tree/v2/detail/xml_parser_read_rapidxml.hpp>

#include <fstream>
#include <string>
#include <locale>

BOOST_PROPERTY_TREE_OPENNS(2) namespace xml_parser {
